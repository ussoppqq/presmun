...
The council started off calm in the morning, with Bangladesh kickstarting the GSL. The council's attention is quickly averted towards China's strong speech, 
demanding the discussion of root causes and loopholes, which then caught the delegate of Netherland's interest in later motion.

USA, however, started to show arrogance once the unmoderated caucus unfolded, with the main topic of root causes, loopholes, and possible solutions. 
"We believe that everyone is facing the same issue, and that is why we propose for us to be one bloc.", delegate of USA said. This proposal rapidly raises disagreements across the discussion circle, where China steps in for a rebuttal towards USA's statement, along with Netherlands. "It's not effective.", says the delegate of Netherlands.

"Not every country faces the same issue,", China said, "and by putting everyone in the same bloc, it'll be a struggle for us to differentiate each state's problem.". 
Delegate of Brazil, agreeing with China, added, "We can't fully cut gas emissions, because it occurs daily and the usage ofgas is necessary in today's civilization." 
Later on, the council split into two respectful groups, EU and G77 members.

The second moderated caucus lead into a more comprehensive discussion, such as the strengthening of global resilience and capacity 
building assist for developing countries. Delegate of USA, once again, tried to test China's stance (and possibly patience), 
by criticizing their 'half-hearted' effort on repairing coastal lines, that there has been no significant progress since the start.
